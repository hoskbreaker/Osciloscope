...
void (* const g_pfnVectors[])(void) =
{
    ...
    configCOMPARADOR_ISR,                      // ADC Sequence 2
    configDMA_ISR,                      // ADC Sequence 3
    ...
    configBOTON_ISR,                      // GPIO Port F
    IntDefaultHandler,                      // GPIO Port G
    IntDefaultHandler,                      // GPIO Port H
    IntDefaultHandler,                      // UART2 Rx and Tx
    IntDefaultHandler,                      // SSI1 Rx and Tx
    configALD_ISR,                      // Timer 3 subtimer A
    ...
    configCOMPARADOR_ISR,                      // ADC1 Sequence 2
    configDMA_ISR,                      // ADC1 Sequence 3
    0,                                      // Reserved
    0,                                      // Reserved
